...
target_include_directories(${PROJECT_NAME_SHARED} PUBLIC ${LIBMEMORYSLOT_INCLUDE_DIR})
target_link_libraries(${PROJECT_NAME_SHARED} ${LIBMEMORYSLOT_LIBRARIES})
...
target_include_directories(${PROJECT_NAME_STATIC} PUBLIC ${LIBMEMORYSLOT_INCLUDE_DIR})
target_link_libraries(${PROJECT_NAME_STATIC} ${LIBMEMORYSLOT_LIBRARIES})
...
foreach (filePath ${files} )
    ...
    target_include_directories(${executableName} PUBLIC ${LIBMEMORYSLOT_INCLUDE_DIR})
    target_link_libraries(${executableName} ${LIBMEMORYSLOT_LIBRARIES})
